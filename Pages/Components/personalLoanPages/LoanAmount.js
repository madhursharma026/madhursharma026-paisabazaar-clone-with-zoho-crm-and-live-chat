...
export default function LoanAmount({navigation}) {
    ...
    <View style={styles.container}>
      ...
      <View style={{paddingLeft: 20, paddingRight: 20}}>
        ...
        <Text style={{textAlign: 'right', marginTop: -20}}>
          <Text style={styles.subHeading}>Step 7/8</Text>
        </Text>

        <View style={{marginTop: 10}}>
          <Text style={styles.mainHeading}>
            Select your desired Personal Loan Amount
          </Text>
        </View>
      </View>
      <RadioButton.Group
        ...
        <View style={styles.row}>
          <View
            style={styles.column}
            onTouchStart={() => (
              setChecked('3Lac'), movetoBestOfferPage('3Lac')
            )}>
            <View style={styles.row}>
              <View style={{flex: 11}}>
          ...
          <View
            style={styles.column}
            onTouchStart={() => (
              setChecked('3to4Lac'), movetoBestOfferPage('3to4Lac')
            )}>
            <View style={styles.row}>
              <View style={{flex: 11}}>
        ...
        <View style={{marginTop: 40}}>
          <View style={styles.row}>
            <View
              style={styles.column}
              onTouchStart={() => (
                setChecked('4to5Lac'), movetoBestOfferPage('4to5Lac')
              )}>
              <View style={styles.row}>
                <View style={{flex: 11}}>
            ...
            <View
              style={styles.column}
              onTouchStart={() => (
                setChecked('5to10Lac'), movetoBestOfferPage('5to10Lac')
              )}>
              <View style={styles.row}>
                <View style={{flex: 11}}>
                  <Text style={styles.radioHeading}>
        ...
        <View style={{marginTop: 40}}>
          <View style={styles.row}>
            <View
              style={styles.column}
              onTouchStart={() => (
                setChecked('10to15Lac'), movetoBestOfferPage('10to15Lac')
              )}>
              <View style={styles.row}>
                <View style={{flex: 15}}>
                  <Text style={styles.radioHeading}>
            ...
            <View
              style={styles.column}
              onTouchStart={() => (
                setChecked('15PlusLac'), movetoBestOfferPage('15PlusLac')
              )}>
              <View style={styles.row}>
                <View style={{flex: 11}}>
                  <Text style={styles.radioHeading}>
